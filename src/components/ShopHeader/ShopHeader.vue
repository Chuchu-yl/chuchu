<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:` url(${info.bgImg})`}">
      <a class="back">
        <i class="iconfont icon-arrow_left" @click="$router.push('/mysite')" />
      </a>
    </nav>
    <div class="shop-content" @click="isShowShoper=!isShowShoper">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowLower=!isShowLower">
      <div class="discounts-left">
        <div class="activity activity-red">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowShoper">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowShoper=!isShowShoper">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isShowShoper=!isShowShoper"></div>
      </div>
    </transition>

    <transition name='move'>
      <div class="activity-sheet" v-show="isShowLower">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="isShowLower=!isShowLower">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="activity-sheet-cover" @click="isShowLower=!isShowLower"></div>
      </div>
    </transition>
  </div>
</template>
